# mcp_devreferencias-2025
Conteúdos da apresentação "Desenvolvendo MCP Servers: integrando com facilidade as mais variadas tecnologias a soluções de IA!".
...
- Exemplo de uso do MCP para MySQL: https://github.com/renatogroffe/mcp-mysql-fakedata
